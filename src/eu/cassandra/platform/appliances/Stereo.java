...
//  // Constructor
//  public Stereo (String name, Installation inst)
//  {
//    super(name);
//
//    Random r = new Random();
...
//    if (temp < AppliancesConstants.STEREO_SATURATION) {
//
//      double powerOn = Math.abs(r.nextGaussian()) * AppliancesConstants.STEREO_POWER_MEAN + AppliancesConstants.STEREO_POWER_VARIANCE;
//      double powerOff = 0;
//
...
//
//  // Constructor
//  public Stereo (String name, Installation inst, double powerOn, int durationOn)
//  {
//    super(name);
//

...
//  // Constructor
//  public TV (String name, Installation inst)
//  {
//    super(name);
//
//    Random r = new Random();
...
//    if (temp < AppliancesConstants.TV_SATURATION) {
//
//      double powerOn = Math.abs(r.nextGaussian()) * AppliancesConstants.TV_POWER_MEAN + AppliancesConstants.TV_POWER_VARIANCE;
//      double powerOff = 0;
//
...
//
//  // Constructor
//  public TV (String name, Installation inst, double powerOn, int durationOn)
//  {
//    super(name);
//
